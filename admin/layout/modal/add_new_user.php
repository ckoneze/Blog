<?php
      ...
      if (isset($_POST['save_user']))
      {
        ...
        $sql_add_user = "INSERT INTO users(name,username,email,gender,image,code,status,type) VALUES('$add_user_name', '$add_user_username', '$add_user_email', '$add_user_gender', '$add_user_image', '$add_user_code', '$add_user_status', '$add_user_type')";
